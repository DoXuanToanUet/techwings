...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220316_1adbe62302202c458520_20220317120300_archive.zip';
	const ARCHIVE_SIZE		 = '64677592';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1adbe62-17120300';
    const SECONDARY_PACKAGE_HASH = 'f71267b-17120300';
	const VERSION			 = '1.4.4';
